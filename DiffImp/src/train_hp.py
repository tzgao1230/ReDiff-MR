...
from baselines import Transformer
...
def run_pcf(sample_dataset, train_dataloader, test_dataloader, config, special_input=None, exp_num='', existing_model=None, mode="multilabel", aux_data=None):
    ...
    trainer = Trainer(
        ...
        device='cuda:' + str(0) if config['USE_CUDA'] else 'cpu',
...
def get_task_fn(config):
    ...
    # 药物推荐
    from data import drug_recommendation_miii_fn
    from data import drug_recommendation_miv_fn
    from data import drug_recommendation_eICU_fn
    all_fn = {
        'MIII': {
            ...
            # 药物推荐
            'DRUG_fn': drug_recommendation_miii_fn,
        },
        'MIV': {
            'PHE_fn': None,
            'DIAG_fn': None,
            ...
            'MOR_fn': None,  # 下次补上
            'REA_fn': None,
            'DRUG_fn' : drug_recommendation_miv_fn
        ...
        'eICU': {
            ...
            'MOR_fn': None,
            'REA_fn': None,
            'DRUG_fn' : drug_recommendation_eICU_fn
