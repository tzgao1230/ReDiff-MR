...
def multilabel_metrics_fn(
    ...
    # y_true = np.asarray(y_true).squeeze(1).astype(int)      # (N, L)  int
    # y_pred = np.asarray(y_pred).squeeze(1).astype(int)      # (N, L)  int
    # y_prob = np.asarray(y_prob).squeeze(1).astype(np.float32)
